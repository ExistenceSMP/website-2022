...
<div class="logo">
	{#if page?.logo}
		{@html page.logo}
	{:else}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819.77 918.89"
			><defs
				><style>
					.cls-1 {
						fill: none;
