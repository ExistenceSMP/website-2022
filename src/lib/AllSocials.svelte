<script>
	import SocialButton from '$lib/util/SocialButton.svelte';
</script>

<div class="socials">
	<SocialButton platform="youtube" href="https://youtube.com/ExistenceSMP">
		...
		<div class="icon">
			<svg
				...
				xml:space="preserve"
				><path id="Triangle" fill="#D72523" d="M407,493l276-143L407,206V493z" /><path
					id="The_Sharpness"
					opacity="0.12"
					fill="#420000"
	...
	<SocialButton platform="twitter" href="https://twitter.com/ExistenceSMP">
		...
		<div class="icon">
			<svg
				...
				><title>Twitter_Logo_Blue</title><rect class="cls-1" width="400" height="400" /><path
					class="cls-2"
	...
	<SocialButton platform="discord" href="https://discordapp.com/invite/0149hOv271sOMiFJq">
	...
	<SocialButton platform="patreon" href="https://www.patreon.com/ExistenceSMP">
		<span>Support us on on Patreon</span>
		<div class="icon">
